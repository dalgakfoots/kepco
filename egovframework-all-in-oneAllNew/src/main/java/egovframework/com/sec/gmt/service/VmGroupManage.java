...
public class VmGroupManage extends ComDefaultVO {
	/**
	 * serialVersionUID
	 */
	 ...
	 * 그룹 관리
	 */
	private VmGroupManage groupManage;
	/**
	 * 그룹 ID
	 */
	 ...
	 * @return GroupManage
	 */
	public VmGroupManage getGroupManage() {
		return groupManage;
	}
	/**
	 ...
	 */
	public void setGroupManage(VmGroupManage groupManage) {
