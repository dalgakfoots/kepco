...
//import egovframework.com.utl.socket.service.BroadSocket.User;
...
public class Admin {
	...
	public static void sendMessage(ChattingUser user, String message) {
		// TODO Auto-generated method stub
		send("{\"status\":\"message\", \"key\":\"" + user.getKey() + "\", \"message\":\"" + message + "\" , \"userId\":\""+user.getUserId()+"\"}");
	}
