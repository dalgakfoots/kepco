...
@ServerEndpoint("/newArticleAlarmSender")
public class NewArticleAlarmSender {
	...
	public void handleOpen(Session userSession) {
		...
		for(String key : NewArticleAlarmReceiver.getUserKeys()) {
			visit(key); // 전송
		}
	}
	...
	public void handleMessage(String message, Session userSession) throws IOException {
		...
		NewArticleAlarmReceiver.sendMessage(message);
	}
