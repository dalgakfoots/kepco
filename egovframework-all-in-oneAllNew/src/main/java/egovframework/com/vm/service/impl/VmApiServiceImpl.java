...
public class VmApiServiceImpl extends EgovAbstractServiceImpl implements VmApiService {
	...
	public String getTicketForUrl() throws Exception{
        try {
            String cookie = getCookie();
            if(cookie != null && cookie.length() > 0) {
                Map<String, String> information = getInformation(cookie);
                if (!information.isEmpty()) {
                    Map<String, String> ticket = getTicket(cookie, information.get("session_id"), information.get("jwp"), information.get("orgId"));
                    if (ticket != null) {
    ...
    public String getCookie() throws Exception{
        ...
        String urlParameters = "service=tenant:WebConsole-test&username=covim&password=C0resec1!";
        byte[] postData = urlParameters.getBytes( StandardCharsets.UTF_8 );
        int postDataLength = postData.length;
        String request = "https://vmware.ncloud.com/login/security_check";
        ...
        connection.setRequestProperty ("Referer", "https://vmware.ncloud.com/login/?service=tenant:WebConsole-test&redirectTo=%2Ftenant%2FWebConsole-test");
    ...
    public Map<String, String> getInformation(String cookie) throws Exception{
        ...
        URL url = new URL("https://vmware.ncloud.com/tenant/WebConsole-test/vdcs/af12fdf1-127d-4884-a920-180e610dd664/vm");
    ...
    public Map<String, String> getTicket(String cookie, String sessionId, String jwp, String orgId)throws Exception {
        HttpURLConnection connection = null;
        String request = "https://vmware.ncloud.com/api/vApp/vm-8b02c194-5364-449d-9e62-16d8152e0332/screen/action/acquireMksTicket";
        URL url= new URL( request );
        connection= (HttpURLConnection) url.openConnection();
        connection.setRequestMethod( "POST" );
        ...
        connection.setRequestProperty ("Referer", "https://vmware.ncloud.com/tenant/WebConsole-test/vdcs/af12fdf1-127d-4884-a920-180e610dd664/vm");
        connection.setRequestProperty ("sec-ch-ua", "\" Not;A Brand\";v=\"99\", \"Google Chrome\";v=\"91\", \"Chromium\";v=\"91\"");
        connection.setRequestProperty ("sec-ch-ua-mobile", "?0");
        connection.setRequestProperty ("Sec-Fetch-Dest", "empty");
        connection.setRequestProperty ("Sec-Fetch-Mode", "cors");
