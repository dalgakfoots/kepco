...
<div class="wTableFrm">
	...
	<div class="btn">
		...
		<input type="button" class="s_submit" value="<spring:message code="button.delete" />" title="<spring:message code="title.delete" /> <spring:message code="input.button" />" onclick="javascript:fn_egov_delete_bbs('${result.bbsId}')" /><!-- 수정 -->
