...
<html>
<head>
<title>훈련문제그룹 <spring:message code="title.create" /></title><!-- 그룹관리 등록 -->
...
function fncSelectGroupList() {
    ...
    varFrom.action = "<c:url value='/uss/olh/faq/selectFaqGroupList.do'/>";
    varFrom.submit();
}
...
<form id="groupManage" method="post" action="${pageContext.request.contextPath}/uss/olh/faq/EgovFaqGroupInsert.do" onSubmit="fncGroupInsert(document.forms[0]); return false;"> 
<div class="wTableFrm">
	<!-- 타이틀 -->
	...
	<tbody>
		...
		<tr>
			...
			<td class="left">
				<input type="text" name="faqGroupNm" title="${title} ${inputTxt}" size="40" maxlength="50" />
			</td>
		</tr>
		<!-- 설명 -->
