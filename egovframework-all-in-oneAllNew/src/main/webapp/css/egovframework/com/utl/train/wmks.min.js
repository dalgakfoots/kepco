(function () {
  ...
  WMKS = {}, WMKS.LOGGER = new function () {
      ...
      this.isChromeOS = a.indexOf("cros") !== -1 ? c : d, this.isWindows = a.indexOf("windows") !== -1 ? c : d, this.isLinux = a.indexOf("linux") !== -1 ? c : d, this.isMacOS = a.indexOf("macos") !== -1 || a.indexOf("macintosh") > -1 ? c : d, this.isMobileTouchDevice = this.isIOS() || this.isAndroid() || this.isBB() ? c : d, this.isTouchDevice = this.isMobileTouchDevice() || this.isChromeClient ? c : d;
      var f = function (b, c) {
        var d = a.match(b);
      ...
      this.version = {
        full: ""
      }, this.isSafari() ? this.version.full = f(/Version[ \/]([0-9\.]+)/i, 1) : this.isChrome() ? this.version.full = f(/Chrome\/([0-9\.]+)/i, 1) : this.isFirefox() ? this.version.full = f(/(?:Firefox|Iceweasel)[ \/]([0-9\.]+)/i, 1) : this.isOpera() ? this.version.full = f(/Version[ \/]([0-9\.]+)/i, 1) || f(/(?:opera|opr)[\s\/]([0-9\.]+)/i, 1) : this.isIE() && (this.version.full = f(/(?:\b(MS)?IE\s+|\bTrident\/7\.0;.*\s+rv:|\bEdge\/)([0-9\.]+)/i, 2));
      var g = this.version.full.split(".");
      this.version.major = parseInt(g.length > 0 ? g[0] : 0, 10), this.version.minor = parseInt(g.length > 1 ? g[1] : 0, 10), this.version.float = parseFloat(this.version.full), this.isCanvasSupported = function () {
        try {
    ...
    function () {
      ...
      return this.options = $.extend({}, this.options, a), $.extend(this, {
        ...
        _isInMultimonMode: !1,
        _multiMonRects: null
      }), this.setRenderCanvas(this.options.canvas), this.options.backCanvas && (this._canvas = this._canvas.concat([this.options.backCanvas]), this._canvas[1].ctx = this.options.backCanvas.getContext("2d")), this.options.blitTempCanvas && (this._canvas = this._canvas.concat([this.options.blitTempCanvas]), this._canvas[2].ctx = this.options.blitTempCanvas.getContext("2d")), this.options.mediaPlayer && (this._mp4Decoder = new e), this.options.multimonRenderer && (this._multimonRenderer = this.options.multimonRenderer), typeof createImageBitmap != "undefined" ? (this._useImageBitmaps = !0, this._imageManager = null) : this._imageManager = new d(256), this._releaseImage = function (a) {
      ...
      if (this._serverInitialized && this.useVMWRequestStreamState) {
        var b = [];
        b.push8(this.msgVMWClientMessage), b.push8(this.msgVMWRequestStreamState), b.push16(8), b.push32(a), this._sendBytes(b)
      }
    }, WMKS.VNCDecoder.prototype._changeCursor = function (a, b, d, e, f, g) {
      function r(a, b, c) {
        !b || (d = b), !c || (e = c), q._currentCursorURI = "url(" + a + ") " + d + " " + e + ", default", q._updateCanvasCursor(a)
      }
      var h = [],
        i = f * g * 4,
        j = Math.ceil(f * g / 8),
      ...
      var b, c;
      this._cursorVisible ? WMKS.BROWSER.isIE() ? b = "default" : b = this._currentCursorURI : WMKS.BROWSER.isFirefox() && WMKS.BROWSER.isMacOS() ? b = "none, !important" : b = "none", c = this._mediaPlayer || this._canvas[0], c.style.cursor !== b && (c.style.cursor = b), c.cursorShadowImg !== a && a !== undefined && (c.cursorShadowImg = a, this.options.onCursorUrlChanged(a))
      ...
      var b = this._readBytes(this.nextBytes),
        ...
        e = this,
        f;
      a.subEncoding === this.subEncDiffJpeg && (b = this._decodeDiffComp(b, this._lastJpegData)), a.subEncoding !== this.subEncPNG ? (this._lastJpegData = b, f = "image/jpeg") : f = "image/png", this._useImageBitmaps ? (WMKS.BROWSER.isChromeClient && this._isInMultimonMode && (a.image2 = {
        data: b,
        type: f
      ...
      })) : (a.image = this._imageManager.getImage(), a.image.width = a.width, a.image.height = a.height, d ? (a.image.onload = this.onDecodeObjectURLComplete, a.image.src = d.createObjectURL(new Blob([b], {
        type: f
      ...
      a.subEncoding = this._readByte(), a.subEncoding &= this.subEncMask, this._mediaPlayer && !this._customRendererEnabled() && this.options.onEncodingChanged("TightPNG");
      ...
      var b = this._readInt16(),
        c = this._readInt16(),
        d = this._readInt32();
      b === 1 && (WMKS.LOGGER.log("Raw H264 encoding is selected and stream is reset."), this._customRendererEnabled() || this.options.onEncodingChanged("RawH264")), this._setReadCB(d, this._readH264Data, a)
      ...
      return this.options.enableSubRectangleCache && this._updateCacheInitialized() && this.cacheFlags & this.updateCacheCapSubRectangle
      ...
      }, h = Math.ceil(b.width / 16), i = Math.ceil(b.height / 16), c.encodedMaskRect = b, c.mask = a.data, c.maskLength = a.dataLength, o = new WMKS.BitBuf(c.mask, c.maskLength), d = !o.readBits(1), e = 0;
      do e == 0 && (e = o.readEliasGamma(), d = !d), n = Math.min(l - j, h - f), n = Math.min(n, e), d && (this._canvas[0].ctx.drawImage(c.image, j * 16, k * 16, n * 16, 16, b.x + f * 16, b.y + g * 16, n * 16, 16), j += n, j == l && (j = 0, k++)), f += n, f == h && (f = 0, g++), e -= n; while (g < i && !o._overflow);
      ...
      do p == 0 && (p = n.readEliasGamma(), o = !o), r == 0 && (r = m.readEliasGamma(), q = !q), h = f - d, h = Math.min(h, p), o && (h = Math.min(h, k - i), h = Math.min(h, r), q && this._canvas[0].ctx.drawImage(b.image, i * 16, j * 16, h * 16, 16, c.x + d * 16, c.y + e * 16, h * 16, 16), i += h, i == k && (i = 0, j++), r -= h), d += h, d == f && (d = 0, e++), p -= h; while (e < g && !m._overflow && !n._overflow)
      ...
      if (this._customRendererEnabled()) {
        ...
        for (a = 0; a < this.rects; a++) this._executeRectSingleForMultimon(this.rect[a], h, g, f), delete this.rect[a]
      } else {
        for (a = 0; a < this.rects; a++) this._executeRectSingle(this.rect[a]), delete this.rect[a];
        this.sendACK()
      }
      this.rects = 0, this.rectsRead = 0, this.rectsDecoded = 0, this.updateReqId = 0, this._receivedFirstUpdate === !1 && (this.options.onConnected(), this._receivedFirstUpdate = !0);
      var i = this;
      ...
      this._serverInitialized && this.useVMWRequestResolution && (a !== this.requestedWidth || b !== this.requestedHeight) && (this.resolutionRequestActive = !0, clearTimeout(this.resolutionTimer), this.resolutionTimer = setTimeout(this.resolutionTimeout, this.resolutionDelay), this.requestedWidth = a, this.requestedHeight = b, this._isInMultimonMode = !1, this._multiMonRects = null)
    }, WMKS.VNCDecoder.prototype.onRequestTopology = function (a) {
      this.requestedWidth = 0, this.requestedHeight = 0, this._serverInitialized && this.useVMWRequestMultiMon && (WMKS.LOGGER.log("Calling _sendTopologyRequest with arg:" + JSON.stringify(a)), this._sendTopologyRequest(a), this._isInMultimonMode = !0, this._multiMonRects = a)
    }, WMKS.VNCDecoder.prototype.disconnect = function () {
      "use strict",
      this._state !== this.DISCONNECTED && (this._state = this.DISCONNECTED, this._mp4Decoder && (this._mp4Decoder.reset(), this._mp4Decoder = null), this._isInMultimonMode && (this._customRendererEnabled() && this._multimonRenderer.reset(), this._isInMultimonMode = !1, this._multiMonRects = null), this._multimonRenderer = null, this._receiveQueueReset(), this.rects = 0, this._receivedFirstUpdate = !1, this._websocket && (this._sendSessionClose(23), this._websocket.onopen = null, this._websocket.onclose = null, this._websocket.onmessage = null, this._websocket.onerror = null, this._websocket.close(), delete this._websocket), this._serverInitialized = !1)
      ...
      a ? this._streamState &= ~this.streamStateDisableAudio : this._streamState |= this.streamStateDisableAudio, this._sendRequestStreamState(this._streamState)
    }, WMKS.VNCDecoder.prototype.setVideoStreamEnabled = function (a) {
      a ? this._streamState &= ~this.streamStateDisableVideo : this._streamState |= this.streamStateDisableVideo, this._sendRequestStreamState(this._streamState)
    }, WMKS.VSCAN_CODES = {
      VSCAN_LCONTROL: 29,
      VSCAN_RCONTROL: 285,
      VSCAN_LSHIFT: 42,
      ...
      this._vncDecoder = a.vncDecoder, this.ignoredRawKeyCodes = a.ignoredRawKeyCodes, this.fixANSIEquivalentKeys = a.fixANSIEquivalentKeys, this.mapMetaToCtrlForKeys = a.mapMetaToCtrlForKeys, this.keyDownKeyTimer = null, this.keyDownIdentifier = null, this.pendingKey = null, this.addCtrlKey = !1, this.activeModifiers = [], this.keyToUnicodeMap = {}, this.keyToRawMap = {}, this.keyboardLayoutId = a.keyboardLayoutId, this.UnicodeToVScanMap = WMKS.CONST.KB.VScanMap[this.keyboardLayoutId], this._windowsKeyManager = {
        ...
        case "es-ES":
          ...
          break;
        case "pt-PT":
          (b == 123 || b == 167) && (d || WMKS.BROWSER.isFirefox) && WMKS.BROWSER.isWindows() && (b == 123 ? b = 55 : b == 167 && (b = 52)), WMKS.BROWSER.isFirefox && WMKS.BROWSER.isWindows() && (a.key == "«" && (b = 187), a.key == "À" && (b = 333)), a.keyCode == 192 && WMKS.BROWSER.isChrome && WMKS.BROWSER.isWindows() && (b = 333);
          break;
        case "fr-FR":
        ...
        case "de-CH":
          ...
          WMKS.BROWSER.isWindows() && e && (b = this.getRemapFrChAltgrKey(b)), a.key === "§" && e && WMKS.BROWSER.isMacOS() && (b = 232), a.key === "À" && (a.keyCode || a.which) === 192 && this.keyboardLayoutId === "de-CH" && c !== 65 && (WMKS.BROWSER.isMacOS() || WMKS.BROWSER.isFirefox() && WMKS.BROWSER.isWindows()) && (b = 1224), b = this.getRemapPendingKey(b, c)
        }
        ...
        this._vncDecoder.allowVMWKeyEvent2UnicodeAndRaw && d !== !0 ? this._vncDecoder.onVMWKeyUnicode(a, !b, !c) : this._sendVScanCode(a, b, c)
      ...
      125: 27,
      34: 40
    }, WMKS.CONST.KB.VScanMap["en-US"] = $.extend({}, WMKS.CONST.KB.UnicodeOnly, WMKS.CONST.KB.UnicodeWithShift), WMKS.CONST.KB2 = {
      ...
      ModifierKeys: [WMKS.VSCAN_CODES.VSCAN_LGUI, WMKS.VSCAN_CODES.VSCAN_RGUI, WMKS.VSCAN_CODES.VSCAN_LCONTROL, WMKS.VSCAN_CODES.VSCAN_RCONTROL, WMKS.VSCAN_CODES.VSCAN_LSHIFT, WMKS.VSCAN_CODES.VSCAN_RSHIFT, WMKS.VSCAN_CODES.VSCAN_LALT, WMKS.VSCAN_CODES.VSCAN_RALT]
    }, WMKS.KeyboardManager2 = function (a) {
      "use strict";
      if (!a || !a.vncDecoder) return null;
      this._vncDecoder = a.vncDecoder, this._serverKeyboardLeds = 0, this._guiToCtrlVScanMap = a.mapMetaToCtrlForVScans || {}, this._enableWindowsKey = a.enableWindowsKey || !1, this._clientModifierStatus = {}, this._serverModifierStatus = {}, this.onKeyDown = function (a) {
        ...
        WMKS.CONST.KB2.ModifierKeys.indexOf(c) !== -1 && (this._clientModifierStatus[c] = !0), this.checkKeyboardLedSync(a, c);
        if (this._enableWindowsKey && (WMKS.CONST.KB2.ControlKeys.indexOf(c) !== -1 || WMKS.CONST.KB2.GuiKeys.indexOf(c) !== -1)) {
          if (this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_LCONTROL] && this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_LGUI]) return this._serverModifierStatus[WMKS.VSCAN_CODES.VSCAN_LCONTROL] && this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_LCONTROL, !1), this._serverModifierStatus[WMKS.VSCAN_CODES.VSCAN_LGUI] || this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_LGUI, !0), !1;
          if (this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_RCONTROL] && this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_RGUI]) return this._serverModifierStatus[WMKS.VSCAN_CODES.VSCAN_RCONTROL] && this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_RCONTROL, !1), this._serverModifierStatus[WMKS.VSCAN_CODES.VSCAN_RGUI] || this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_RGUI, !0), !1
        }
        return this._guiToCtrlVScanMap.indexOf(c) !== -1 && (this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_LGUI] && !this._serverModifierStatus[WMKS.VSCAN_CODES.VSCAN_LCONTROL] && this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_LCONTROL, !0), this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_RGUI] && !this._serverModifierStatus[WMKS.VSCAN_CODES.VSCAN_RCONTROL] && this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_RCONTROL, !0)), WMKS.CONST.KB2.GuiKeys.indexOf(c) !== -1 ? !1 : (WMKS.BROWSER.isWindows() && (c == WMKS.VSCAN_CODES.VSCAN_RALT ? this._serverModifierStatus[WMKS.VSCAN_CODES.VSCAN_LCONTROL] && this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_LCONTROL, !1) : a.originalEvent.getModifierState("AltGraph") && !this._serverModifierStatus[WMKS.VSCAN_CODES.VSCAN_RALT] && this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_RALT, !0)), this.sendVScanKey(c, !0), WMKS.BROWSER.isMacOS() && (c == WMKS.VSCAN_CODES.VSCAN_CAPSLOCK && this.sendVScanKey(c, !1), (this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_LGUI] || this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_RGUI]) && WMKS.CONST.KB2.ModifierKeys.indexOf(c) == -1 && this.sendVScanKey(c, !1)), !1)
      }, this.onKeyPress = function (a) {
        ...
        if (WMKS.CONST.KB2.ControlKeys.indexOf(c) !== -1 || WMKS.CONST.KB2.GuiKeys.indexOf(c) !== -1 || this._guiToCtrlVScanMap.indexOf(c) !== -1) {
          this._serverModifierStatus[WMKS.VSCAN_CODES.VSCAN_LGUI] && (!this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_LGUI] || !this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_LCONTROL]) && this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_LGUI, !1), this._serverModifierStatus[WMKS.VSCAN_CODES.VSCAN_RGUI] && (!this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_RGUI] || !this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_RCONTROL]) && this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_RGUI, !1), !!this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_LCONTROL] != !!this._serverModifierStatus[WMKS.VSCAN_CODES.VSCAN_LCONTROL] && this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_LCONTROL, !!this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_LCONTROL]), !!this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_RCONTROL] != !!this._serverModifierStatus[WMKS.VSCAN_CODES.VSCAN_RCONTROL] && this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_RCONTROL, !!this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_RCONTROL]), WMKS.BROWSER.isWindows() && WMKS.BROWSER.isFirefox() && c == WMKS.VSCAN_CODES.VSCAN_LCONTROL && !!this._clientModifierStatus[WMKS.VSCAN_CODES.VSCAN_RALT] && this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_RALT, !1);
          if (WMKS.CONST.KB2.ControlKeys.indexOf(c) !== -1 || WMKS.CONST.KB2.GuiKeys.indexOf(c) !== -1) return !1
        }
        return this.sendVScanKey(c, !1), !1
        ...
        c !== d && (this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_CAPSLOCK, !0), this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_CAPSLOCK, !1)), e !== f && (this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_NUMLOCK, !0), this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_NUMLOCK, !1)), g !== h && (this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_SCROLL, !0), this.sendVScanKey(WMKS.VSCAN_CODES.VSCAN_SCROLL, !1))
      }, this.processInputString = function (a, b) {
        ...
        this._vncDecoder.onKeyVScan(a, b), WMKS.CONST.KB2.ModifierKeys.indexOf(a) !== -1 && (this._serverModifierStatus[a] = b)
      }, this.onKeyboardLEDsChanged = function (a) {
        this._serverKeyboardLeds = a
      }, this.cancelModifiers = function (a) {
        for (var b in this._serverModifierStatus) this._serverModifierStatus[b] && this.sendVScanKey(b, !1);
        this._clientModifierStatus = {}, this._serverModifierStatus = {}
      }, this.clearState = function () {
        this._clientModifierStatus = {}, this._serverModifierStatus = {};
        for (var a = 0; a < WMKS.CONST.KB2.ModifierKeys.length; ++a) this.sendVScanKey(WMKS.CONST.KB2.ModifierKeys[a], !1)
      }
      ...
      this._verifyQuickTouches = function (a, b, c) {
        ...
        if (i.opType === WMKS.CONST.TOUCH.OP.drag) {
          ...
          b.sendMouseButtonMessage(c, !0, WMKS.CONST.CLICK.left, "Touch"), this._showFeedback(j.dragFeedback, a)
        }
        ...
        if (a.targetTouches.length === 3) return WMKS.BROWSER.isChromeOS() || i.opType === WMKS.CONST.TOUCH.OP.none && (i.opType = WMKS.CONST.TOUCH.OP.tap_3finger, this.toggleKeyboard(), i.currentTouchFingers = 3), !1
        ...
        if (i.opType === WMKS.CONST.TOUCH.OP.drag) return i.currentTouch = WMKS.UTIL.TOUCH.copyTouch(a.targetTouches[0]), this.moveCursor(a.targetTouches[0].pageX, a.targetTouches[0].pageY), d = this._applyZoomCorrectionToTouchXY(a.targetTouches[0]), b.sendMouseMoveMessage(d, "Touch"), !1;
        ...
        if (a.targetTouches.length === 0) {
          ...
          case WMKS.CONST.TOUCH.OP.drag:
            return d = a.changedTouches, d.length === 1 ? (c = this._applyZoomCorrectionToTouchXY(d[0]), b.sendMouseButtonMessage(c, !1, WMKS.CONST.CLICK.left, "Touch")) : WMKS.LOGGER.warn("Unexpected touch# " + d.length + " changed in a drag operation!"), this._resetTouchState(), !1;
          default:
        ...
        return b.sendMouseButtonMessage(e, !0, d, "Touch"), i.opType === WMKS.CONST.TOUCH.OP.tap_twice ? (b.sendMouseButtonMessage(e, !1, d, "Touch"), this._showFeedback(j.clickFeedback, a, {
          showTwice: !0
        })) : (e = this._applyZoomCorrectionToTouchXY(c), b.sendMouseButtonMessage(e, !1, d, "Touch"), this._showFeedback(j.clickFeedback, a)), !0
        ...
        }), this.moveCursor(b.pageX + i, b.pageY + j), a.removeClass("animate-feedback-indicator animate-double-feedback-indicator"), h.showTwice ? setTimeout(function () {
    ...
    }, WMKS.widgetProto._updateDisplayScale = function (a) {
      ...
      return e = Math.ceil(this._canvas[0].offsetWidth * this._scale * d) - 1, f = Math.ceil(this._canvas[0].offsetHeight * this._scale * d) - 1, g = Math.min(g, e), h = Math.min(h, f), g = Math.max(g, 0), h = Math.max(h, 0), {
        x: g,
        y: h
      }
      ...
      if (this._vncDecoder && this._isCanvasMouseEvent(a)) {
        var c = a || window.event,
          ...
          e;
        return c.which ? WMKS.BROWSER.isMacOS() && WMKS.BROWSER.isGecko() && c.ctrlKey && c.button === 2 ? (WMKS.LOGGER.trace("FF on OSX: Rewrite Ctrl+Right-click as Ctrl+Left-click."), e = 1) : e = 1 << c.button : e = (c.button & 1) << 0 | (c.button & 2) << 1 | (c.button & 4) >> 1, this.sendMouseButtonMessage(d, b, e, "Mouse")
      }
    }, WMKS.widgetProto.sendMouseButtonMessage = function (a, b, c, d) {
      return this._vncDecoder && (b ? this._mouseDownBMask |= c : this._mouseDownBMask &= ~c, (this._mousePosGuest.x !== a.x || this._mousePosGuest.y !== a.y) && this.sendMouseMoveMessage(a, d), this._vncDecoder.onMouseButton(a.x, a.y, b, c)), !0
      ...
      if (this._vncDecoder && this._shadowCursorPos && this._shadowCursorUrl) {
        ...
        this._shadowCursorIcon === null && ($('<div class="feedback-container cursor-icon-shadow"></div>').insertAfter(this.element), this._shadowCursorIcon = $(".cursor-icon-shadow"));
      ...
      this._vncDecoder && (this.hideShadowCursor(), this._vncDecoder.onMouseMove(a.x, a.y), this._mousePosGuest = a, this._touchHandler && (this._touchHandler.onCaretPositionChanged(a), b !== "Touch" ? this._touchHandler.setCursorVisibility(!1) : this._touchHandler.setCursorVisibility(!0)))
    }, WMKS.widgetProto.sendKeyMessage = function (a) {
      var b = a.type,
        c = a.event;
      c.originalEvent && typeof c.originalEvent.getModifierState != "function" && (c.originalEvent.getModifierState = function (a) {
        var b = this.originalEvent.modifierState;
        return !!b && a in b && b[a]
      }.bind(c)), c.preventDefault || (c.preventDefault = function () {}), c.stopPropagation || (c.stopPropagation = function () {});
      ...
      this.element.unbind("contextmenu.wmks").unbind("keydown.wmks").unbind("keypress.wmks").unbind("keyup.wmks").unbind("mousedown.wmks").unbind("mousewheel.wmks"), this.element.unbind("mousemove.wmks").unbind("mouseup.wmks").unbind("blur.wmks"), $(window).unbind("blur.wmks" + this._wmksId), $(window).unbind("mousemove.wmks" + this._wmksId), $(window).unbind("mousewheel.wmks" + this._wmksId), $(window).unbind("mouseup.wmks" + this._wmksId), $(window).unbind("mousedown.wmks" + this._wmksId), this._touchHandler && this._touchHandler.disconnectEvents()
      ...
      if (b && this._keyboardManager.sendVScanKey) {
        ...
        for (d = 0; d < a.length; d++) {
          var f = a[d];
          f > 0 ? (this._keyboardManager.sendKey(f, !1, !1, c), (f !== 20 || WMKS.BROWSER.isMacOS()) && e.push(f)) : f < 0 && this._keyboardManager.sendKey(0 - f, !0, !0, c)
        }
      ...
      if (!b)
        for (c = 0; c < a.length; c++) a[c].left = a[c].left * this._pixelRatio, a[c].top = a[c].top * this._pixelRatio, a[c].requestedWidth = a[c].requestedWidth * this._pixelRatio, a[c].requestedHeight = a[c].requestedHeight * this._pixelRatio;
      ...
      if (this.transform === null || !!this.options.fitToParent || !!this.options.fitGuest)
        if (this.transform !== null && this.options.fitToParent) {
          var i = e / g,
            j = f / h;
          c = (e - g) / 2, d = (f - h) / 2, b = Math.max(.1, Math.min(i, j)), this.options.isFitToViewer === !1 && this.options.isShadow && (b = 1, c = c < 0 ? 0 : c, d = d < 0 ? 0 : d), this._shadowCursorX = (e - g * b) / 2, this._shadowCursorY = (f - h * b) / 2, e - g * b < 0 && (this._shadowCursorX = 0), f - h * b < 0 && (this._shadowCursorY = 0), this._shadowCursorScale = b
        } else this.options.fitGuest && a ? this.updateFitGuestSize(!0) : this.transform === null && WMKS.LOGGER.warn("No scaling support");
      if (this.transform !== null) {
        b !== this._scale && (this._scale = b, this._canvas.css(this.transform, "scale(" + this._scale + ")"), this._video && this._video.css(this.transform, "scale(" + this._scale + ")"));
        if (c !== this._x || d !== this._y) this._x = c, this._y = d, WMKS.LOGGER.debug("Resize canvas, top  is : " + d + ",left is : " + c), this._canvas.css({
          top: d,
          left: c
        }), this._video && this._video.css({
          top: d,
      ...
      WMKS.BROWSER.isIE() && this.options.isFitToViewer === !0 && this.options.isShadow && this._scale < 1 ? this.element.css({
        overflow: "hidden"
      }) : this.element.css({
        overflow: ""
      })
      ...
      this.disconnect(), this.element
        .removeClass("wmks"), !this._touchHandler || (this._touchHandler.destroy(), this._touchHandler = null), this._relativeMouseHandler.destroy(), this._relativeMouseHandler = null, this._canvas.remove(), this._video && this._video.remove(), this._backCanvas && this._backCanvas.remove(), this._blitTempCanvas && this._blitTempCanvas.remove(), $.Widget.prototype.destroy.call(this)
      ...
      this._mouseDownBMask = 0, this._mousePosGuest = {
        x: 0,
        y: 0
      }, this._scale = 1, this._pixelRatio = 1, this.connected = !1, this.isCanvasActive = !1, this._displayScaleRatio = 1, this._wmksId = WMKS.widgetProto.id++, this._shadowCursorIcon = null, this._shadowCursorScale = 1, this._shadowCursorX = 0, this._shadowCursorY = 0, this._shadowCursorPos = null, this._shadowCursorUrl = null, this._canvas = WMKS.UTIL.createCanvas(!0).prop({
        id: "mainCanvas",
        tabindex: 1
      ...
      this.transform = b("transform") || b("WebkitTransform") || b("MozTransform") || b("msTransform") || b("OTransform"), this._vncDecoder = new WMKS.VNCDecoder({
        ...
        onKeyboardLEDsChanged: function (b) {
          a._keyboardManager.onKeyboardLEDsChanged && a._keyboardManager.onKeyboardLEDsChanged(b), a._trigger("keyboardLEDsChanged", 0, b)
        },
      ...
      }), KeyboardEvent.prototype.hasOwnProperty("code") && KeyboardEvent.prototype.hasOwnProperty("getModifierState") && !WMKS.BROWSER.isMobileTouchDevice() && !this.options.disableVscanKeyboard ? this._keyboardManager = new WMKS.KeyboardManager2({
  ...
  g.ENABLE_PROBE_CHANNEL = 1, g.MAJOR_VER = 3, g.MINOR_VER = 0, g.SUPPORTED_VER = [{
    ...
    if (a instanceof m) {
      ...
      for (e = 0; e < d.length; ++e)
        if (d[e].name ===
          b) return this.setLastError(g.STATUS.INVALID_ARGS, "VVC.createListener", 'Invalid name "' + b + '",' + " a listener on this session" + " with this name already exists."), null;
  ...
  g.CHUNK_COMMON_HEADER_SIZE = 4, g.CHUNK_LARGE_HEADER_SIZE = 4, g.CHUNK_EXTENSION_HEADER_SIZE = 4, g.CHUNK_MAX_LEN = 65536, g.CHUNK_LARGE_MAX_LEN = 4294966272, g.SESSION_STATE = {
      ...
      if (!a) {
        this.socket.readyState === WebSocket.OPEN && this.onSessionError(g.STATUS.PROTOCOL_ERROR, "VVCSession.onChannelMessage", "Unknown channel in chunk");
        return
      }
...
function () {
  $.extend(WMKS.CONST, {
    ...
    return d
  }, WMKS.buildNumber = "10720268", WMKS.version = "2.1.0"
}();

//////////////////
// WEBPACK FOOTER
// ./src/wmkssdk/wmks.min.js
// module id = 130
// module chunks = 0