...
public class BoardController {
	...
	public String doLogin(@RequestParam("email") String email, @RequestParam("password") String password, ModelMap model, HttpServletRequest request) {
		
		LoginVO loginVO = new LoginVO();
		loginVO.setEmail(email);
		loginVO.setPassword(password);
		
		String user_name = loginService.selectLoginCheck(loginVO);
